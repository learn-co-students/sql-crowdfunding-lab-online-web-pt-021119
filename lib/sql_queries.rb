...
"SELECT projects.title, (SUM(pledges.amount) - projects.funding_goal) as over_fund FROM projects INNER JOIN pledges ON projects.id=pledges.project_id GROUP BY projects.id HAVING over_fund>=0"
end
